          ...
          <div className="main-content main-content-table overflow-auto">
            <table className="table table-borderless">
              ...
              <tbody id="list_status_item">
                ...
                <TableRow title="COC" category="Mobile" item={200} price={290000} status="Failed" image="overview-3" />
                <TableRow title="Call of Duty:Modern" category="Desktop" item={550} price={740000} status="Success" image="overview-4" />
